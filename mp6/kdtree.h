...
int partition(int left, int right, int dimension, int median);
void select(int k, int left, int right, int dimension);
void buildtree(int left, int right, int dimension);
int finddistance(const Point<Dim> & target, const Point<Dim> & otherpoint) const;
        /**
         * @todo Add your helper functions here.
         */

Point<Dim> findNearestNeighbor(int dimension, const Point<Dim> & query, int left, int right, const Point<Dim> & currentBest) const;
};
