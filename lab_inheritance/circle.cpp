...
Circle::Circle(const Vector2& pcenter, const RGBAPixel& pcolor, int pradius)
	: Shape(pcenter, pcolor),radius_(pradius)//as initialization list
//call the constructor of the base class and if you put into {}, compiler will not know if to build a new shape object or an initialization list
{
