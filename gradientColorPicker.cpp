...
RGBAPixel fadeColor2, int radius, int centerX, int centerY ):fadeColor1(fadeColor1),fadeColor2(fadeColor2),radius(radius),centerX(centerX),centerY(centerY) {
/** 
...
{
RGBAPixel color;
if (abs(centerX-x)+abs(centerY-y)==0) color=fadeColor1;
else if ((abs(centerX-x)+abs(centerY-y))>radius) color=fadeColor2;
else {
int r=fadeColor1.red-(abs(centerX-x)+abs(centerY-y))*fadeColor1.red/radius+(abs(centerX-x)+abs(centerY-y))*fadeColor2.red/radius;
int g=fadeColor1.green-(abs(centerX-x)+abs(centerY-y))*fadeColor1.green/radius+(abs(centerX-x)+abs(centerY-y))*fadeColor2.green/radius;
int b=fadeColor1.blue-(abs(centerX-x)+abs(centerY-y))*fadeColor1.blue/radius+(abs(centerX-x)+abs(centerY-y))*fadeColor2.blue/radius;
color.red=r;
color.green=g;
color.blue=b;
}//end else 
